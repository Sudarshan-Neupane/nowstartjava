	...
	<div class="row" ng-controller="category">
		...
		<div class="col-xs-7 col-md-7 col-sm-7 col-lg-7">
			...
			<div ng-show="! introduction">
				<div class="panel panel-primary" ng-repeat="tutorials in displayTutorial">
					<div class="panel-heading">
						<span class="panel-title">{{ tutorials.title}}</span> <span class="pull-right"> {{ tutorials.dateCreated |
		...
		<div class="col-xs-2 col-md-2 col-sm-2 col-lg-2">
			<div class="panel panel-primary">
				...
				<!-- NowStartJavaHomePage -->
				<ins class="adsbygoogle" style="display: inline-block; width: 161px; height: 600px"
					data-ad-client="ca-pub-1974105567156101" data-ad-slot="5153526872"></ins>
				<script>
